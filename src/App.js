...
function App() {
  ...
  function sendEmail(e) {
    e.preventDefault();
    databaseAdd()
    emailjs.sendForm('gmail', 'template_bidjxos', e.target, 'user_1fseSAxbY7iohjRdwvlQ9')
      .then((result) => {
          console.log(result);
      }, (error) => {
  ...
  return (
    <div className="App">
              <form onSubmit={sendEmail} method="post" role="form" className="php-email-form" >
                ...
                <div className="col-md-6 form-group">
                  <select className="form-control" id="exampleFormControlSelect1" name="category" required>
